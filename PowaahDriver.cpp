...
/* Stuck constants*/
const int PowaahDriver::stuckTime = 25;
const float PowaahDriver::stuckAngle = .523598775; //PI/6

/* Accel and Brake Constants*/
const float PowaahDriver::maxSpeedDist=70;
const float PowaahDriver::maxSpeed=150;
const float PowaahDriver::sin5 = 0.08716;
const float PowaahDriver::cos5 = 0.99619;

/* Steering constants*/
const float PowaahDriver::steerLock=0.785398;
const float PowaahDriver::steerSensitivityOffset=80.0;
const float PowaahDriver::wheelSensitivityCoeff=1;

/* ABS Filter Constants */
const float PowaahDriver::wheelRadius[4]={0.3179,0.3179,0.3276,0.3276};
const float PowaahDriver::absSlip=2.0;
const float PowaahDriver::absRange=3.0;
const float PowaahDriver::absMinSpeed=3.0;

/* Clutch constants */
const float PowaahDriver::clutchMax=0.5;
const float PowaahDriver::clutchDelta=0.05;
const float PowaahDriver::clutchRange=0.82;
const float PowaahDriver::clutchDeltaTime=0.02;
const float PowaahDriver::clutchDeltaRaced=10;
const float PowaahDriver::clutchDec=0.01;
...
float
PowaahDriver::getSteer(CarState &cs)
{
...
float
PowaahDriver::getAccel(CarState &cs)
{
...
CarControl
PowaahDriver::wDrive(CarState cs)
{
...
float
PowaahDriver::filterABS(CarState &cs,float brake)
{
...
void
PowaahDriver::onShutdown()
{
    cout << "Bye bye!" << endl;
}

void
PowaahDriver::onRestart()
{
    cout << "Restarting the race!" << endl;
}

void
PowaahDriver::clutching(CarState &cs, float &clutch)
{
...
void
PowaahDriver::init(float *angles)
{
