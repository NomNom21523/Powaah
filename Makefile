...
OBJECTS = WrapperBaseDriver.o SimpleParser.o CarState.o CarControl.o Agent.o AgentOption.o CurveAgent.o Driver.o MathUtility.o SpeedAgent.o Track.o TrackAgent.o Vector2.o $(DRIVER_OBJ)
