#ifndef POWAAH_DRIVER_H
#define POWAAH_DRIVER_H
...
class PowaahDriver : public WrapperBaseDriver
{
public:

    // Constructor
    PowaahDriver(){stuck=0;clutch=0.0;};

    // PowaahDriver implements a simple and heuristic controller for driving
